...
func Connect() (*sqlx.DB, error) {
	host := os.Getenv("DISPUTE_DB_HOST")
	port := os.Getenv("DISPUTE_DB_PORT")
	name := os.Getenv("DISPUTE_DB_NAME")
	user := os.Getenv("DISPUTE_DB_USER")
	password := os.Getenv("DISPUTE_DB_PASSWORD")
	if password != "" {
		password = ":" + password
	}
